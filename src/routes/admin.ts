...
// plus a live "today so far" row. The VISUAL dashboard is deliberately not on
// the internet — `node scripts/dashboard.mjs` builds it locally via wrangler
// auth (owner ruling 2026-08-30); this JSON stays for emergencies/tooling.
